...
import { IConfig } from '../../src/models/STCard/ISTCard';
...
describe('Card', () => {
  ...
  describe('on init', () => {
    ...
    const config: IConfig = {
      ...
      fields: {
        errors: { cardNumber: '', expirationDate: '', securityCode: '' },
        inputs: { cardNumber: '', expirationDate: '', securityCode: '' }
      },
      locale: ''
    };
    const alternativeInstance: Card = new Card(config);
    // then
    ...
    it('should set _cardDetails', () => {
      // @ts-ignore
      expect(instance._cardDetails.cardNumber).toEqual(CARD_DETAILS_PLACEHOLDERS.CARD_NUMBER);
      // @ts-ignore
      expect(instance._cardDetails.expirationDate).toEqual(CARD_DETAILS_PLACEHOLDERS.EXPIRATION_DATE);
      // @ts-ignore
      expect(instance._cardDetails.securityCode).toEqual(CARD_DETAILS_PLACEHOLDERS.SECURITY_CODE);
    });
  });
